...
mv jobOptions1.txt /pnfs/lar1nd/scratch/users/dcianci/fits/jobOptions.txt
cp run_job_diag.sh run_job_diag1.#!/bin/sh
sed -i -e 's/VMode=""/VMode="CDHSProcess/g' run_job_diag1.#!/bin/sh
jobsub_submit -G lar1nd --role=Analysis -N 100 --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC --OS=SL6 file://'pwd'/run_job_diag.#!/bin/sh
cp jobOptions.txt jobOptions1.txt
cp run_job_diag.sh run_job_diag1.sh
...
mv jobOptions1.txt /pnfs/lar1nd/scratch/users/dcianci/fits/jobOptions.txt
cp run_job_diag.sh run_job_diag1.#!/bin/sh
sed -i -e 's/VMode=""/VMode="CHOOZProcess/g' run_job_diag1.#!/bin/sh
jobsub_submit -G lar1nd --role=Analysis -N 100 --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC --OS=SL6 file://'pwd'/run_job_diag.#!/bin/sh
cp jobOptions.txt jobOptions1.txt
cp run_job_diag.sh run_job_diag1.sh
...
mv jobOptions1.txt /pnfs/lar1nd/scratch/users/dcianci/fits/jobOptions.txt
cp run_job_diag.sh run_job_diag1.#!/bin/sh
sed -i -e 's/VMode=""/VMode="KARMENProcess/g' run_job_diag1.#!/bin/sh
jobsub_submit -G lar1nd --role=Analysis -N 100 --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC --OS=SL6 file://'pwd'/run_job_diag.#!/bin/sh
cp jobOptions.txt jobOptions1.txt
cp run_job_diag.sh run_job_diag1.sh
...
mv jobOptions1.txt /pnfs/lar1nd/scratch/users/dcianci/fits/jobOptions.txt
cp run_job_diag.sh run_job_diag1.#!/bin/sh
sed -i -e 's/VMode=""/VMode="LSNDProcess/g' run_job_diag1.#!/bin/sh
jobsub_submit -G lar1nd --role=Analysis -N 100 --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC --OS=SL6 file://'pwd'/run_job_diag.#!/bin/sh
cp jobOptions.txt jobOptions1.txt
cp run_job_diag.sh run_job_diag1.sh
...
mv jobOptions1.txt /pnfs/lar1nd/scratch/users/dcianci/fits/jobOptions.txt
cp run_job_diag.sh run_job_diag1.#!/bin/sh
sed -i -e 's/VMode=""/VMode="NOMADProcess/g' run_job_diag1.#!/bin/sh
jobsub_submit -G lar1nd --role=Analysis -N 100 --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC --OS=SL6 file://'pwd'/run_job_diag.#!/bin/sh
cp jobOptions.txt jobOptions1.txt
cp run_job_diag.sh run_job_diag1.sh
...
mv jobOptions1.txt /pnfs/lar1nd/scratch/users/dcianci/fits/jobOptions.txt
cp run_job_diag.sh run_job_diag1.#!/bin/sh
sed -i -e 's/VMode=""/VMode="MBProcess/g' run_job_diag1.#!/bin/sh
jobsub_submit -G lar1nd --role=Analysis -N 100 --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC --OS=SL6 file://'pwd'/run_job_diag.#!/bin/sh
cp jobOptions.txt jobOptions1.txt
cp run_job_diag.sh run_job_diag1.sh
...
mv jobOptions1.txt /pnfs/lar1nd/scratch/users/dcianci/fits/jobOptions.txt
cp run_job_diag.sh run_job_diag1.#!/bin/sh
sed -i -e 's/VMode=""/VMode="MBProcessNubar/g' run_job_diag1.#!/bin/sh
jobsub_submit -G lar1nd --role=Analysis -N 100 --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC --OS=SL6 file://'pwd'/run_job_diag.#!/bin/sh
cp jobOptions.txt jobOptions1.txt
cp run_job_diag.sh run_job_diag1.sh
...
mv jobOptions1.txt /pnfs/lar1nd/scratch/users/dcianci/fits/jobOptions.txt
cp run_job_diag.sh run_job_diag1.#!/bin/sh
sed -i -e 's/VMode=""/VMode="NUMIProcess/g' run_job_diag1.#!/bin/sh
jobsub_submit -G lar1nd --role=Analysis -N 100 --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC --OS=SL6 file://'pwd'/run_job_diag.#!/bin/sh
cp jobOptions.txt jobOptions1.txt
cp run_job_diag.sh run_job_diag1.sh
...
mv jobOptions1.txt /pnfs/lar1nd/scratch/users/dcianci/fits/jobOptions.txt
cp run_job_diag.sh run_job_diag1.#!/bin/sh
sed -i -e 's/VMode=""/VMode="MINOSProcess/g' run_job_diag1.#!/bin/sh
jobsub_submit -G lar1nd --role=Analysis -N 100 --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC --OS=SL6 file://'pwd'/run_job_diag.#!/bin/sh
cp jobOptions.txt jobOptions1.txt
cp run_job_diag.sh run_job_diag1.sh
...
mv jobOptions1.txt /pnfs/lar1nd/scratch/users/dcianci/fits/jobOptions.txt
cp run_job_diag.sh run_job_diag1.#!/bin/sh
sed -i -e 's/VMode=""/VMode="GALLIUMProcess/g' run_job_diag1.#!/bin/sh
jobsub_submit -G lar1nd --role=Analysis -N 100 --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC --OS=SL6 file://'pwd'/run_job_diag.#!/bin/sh
cp jobOptions.txt jobOptions1.txt
cp run_job_diag.sh run_job_diag1.sh
...
mv jobOptions1.txt /pnfs/lar1nd/scratch/users/dcianci/fits/jobOptions.txt
cp run_job_diag.sh run_job_diag1.#!/bin/sh
sed -i -e 's/VMode=""/VMode="XSECProcess/g' run_job_diag1.#!/bin/sh
jobsub_submit -G lar1nd --role=Analysis -N 100 --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC --OS=SL6 file://'pwd'/run_job_diag.#!/bin/sh
cp jobOptions.txt jobOptions1.txt
cp run_job_diag.sh run_job_diag1.sh
...
mv jobOptions1.txt /pnfs/lar1nd/scratch/users/dcianci/fits/jobOptions.txt
cp run_job_diag.sh run_job_diag1.#!/bin/sh
sed -i -e 's/VMode=""/VMode="MBDISProcess/g' run_job_diag1.#!/bin/sh
jobsub_submit -G lar1nd --role=Analysis -N 100 --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC --OS=SL6 file://'pwd'/run_job_diag.#!/bin/sh
cp jobOptions.txt jobOptions1.txt
cp run_job_diag.sh run_job_diag1.sh
...
mv jobOptions1.txt /pnfs/lar1nd/scratch/users/dcianci/fits/jobOptions.txt
cp run_job_diag.sh run_job_diag1.#!/bin/sh
sed -i -e 's/VMode=""/VMode="MBDISProcessNubar/g' run_job_diag1.#!/bin/sh
jobsub_submit -G lar1nd --role=Analysis -N 100 --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC --OS=SL6 file://'pwd'/run_job_diag.#!/bin/sh
cp jobOptions.txt jobOptions1.txt
cp run_job_diag.sh run_job_diag1.sh
