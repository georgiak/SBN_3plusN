...
ifdh cp -D /pnfs/lar1nd/scratch/users/dcianci/fits/data/cdhs_noosc.txt .
ifdh cp -D /pnfs/lar1nd/scratch/users/dcianci/fits/data/cdhs_sinsq.txt .
...
chmod u+x cdhs_noosc.txt
chmod u+x cdhs_sinsq.txt
...
ifdh mkdir /lar1nd/data/users/dcianci/output_${VMODE}_3${VSTERILES}

ifdh cp globFit.root /lar1nd/data/users/dcianci/output_${VMODE}_3${VSTERILES}/globFit_${PROCESS}.root
