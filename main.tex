...
Additionally we hightlight that if the light detection system employed by SBND
and ICARUS can achieve $\approx$nano-second timing resolution, it in principle allows
for observable structure in the temporal distribution of events relative to the
neutrino beam-buckets. When combined with spectral energy information, this
allows SBN to act in a near backgroundless environment, whilst also providing a
...
sterile shown on the left \reffig{fig:timing}\marcom{PB}{Where should this point?}. For
