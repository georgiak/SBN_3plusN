...
\marcom{PB}{Others? Schrock?}, and we have plotted the branching ratios for sterile
...
excluded under current BBN measurements \cite{Dolgov:2000j}.\marcom{PB}{Fix me.} In the minimal
...
%
\marcom{MARK}{I cannot find an accurate source, Andzrej was the first person to
highlight it so I will ask him. }
...
beam-off measurements \cite{Antonello:2015lea}. However a full analysis of this
background is beyond the scope of this work. \marcom{PB}{Tweak this?}  
...
anomaly is indeed from the decay of a heavy propagating sterile. Non-observation of any excess at $\mu$BooNE would not negatively effect the program for a subsequent search at SBND or ICARUS as a large amount of their probable parameter space is not available to $\mu$BooNE.  \marcom{PB}{Reduce this paragraph?}
