...
As a representative example of iour analysis we discuss the backgrounds
...
$\mu$BooNE (SBND) from around $10^5, (1.5\times10^6)$ to around $30 (300)$
...
section,\marcom{PB}{We essentially had no discussion of this. Just apologia.
Let me know if it's OK.} we consider only the timing of events relative to the
