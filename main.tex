...
\newtext{MARK}{I have text planned to explain this plot, but sleep first, I'll get it up as soon as I can tomorrow morning. I also have a contour plot to go alongside it.}
\begin{figure}[t]
\center
\includegraphics[width=0.65\textwidth]{figures/hockey_plot.pdf}
\caption{\label{fig:hockey}
	\emph{Left:}Expected significance by which ICARUS can exclude an excess to be associated with the beam-bucket, in favour of a decay-in-flight model as a function of timing resolution. Assumes 100 observed events. }
