...
\abstract{
%
If a sterile neutrino exists it would be naturally produced in the beam of the
Short-Baseline Neutrino (SBN) program at Fermilab. In this article we study the
potential for SBN to constrain models of these particles with massess at the
MeV scale.  
%
...
SBND and ICARUS can achieve nano-second timing resolution, the effect of finite
sterile neutrino mass may be observable as events are expected to arrive
outside the neutrino beam-buckets. When combined with spectral energy
information, by focusing on this region SBN can significantly reduce its
beam-correlated background in a search for new physics, while through the
comparision of event timing distributions at near and far detectors, it can
also provide a smoking-gun signature for this class of models.
%
We stress throughout that this is a complementary new physics analysis to the
standard eV-scale oscillations, extending the BSM programme of SBN while
