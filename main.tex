...
identical. 
%
However, as mentioned above, PS-191 was purposefully built to search for decays
...
that many events still fall in the in beam timing window for SBND; however,
 Icarus see significant deviation from this with clear peaks in
...
\section{\label{sec:timing_physics}Timing for model discrimination}
