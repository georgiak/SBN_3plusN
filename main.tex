...
\item Write code for general $\Gamma$ for different final state particles.
\newtext{PB}{Hey Mark, I'm having a got at this Thursday 28th 09.00. Contact me
if there'll be any conflicts.}
...
we compute the bounds (this should be easier than with our $Z^\prime$ model, as
we don't have to think about invisible decays... just enlarged decays to
visible. I guess everything strenghtens up to the point that PS191 sees nothing
etc.)? How do we display the three dimensional data etc. Make these plots.
