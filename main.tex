...
(or secondary $\mu^\pm$ decays), and we assume that the sterile neutrinos are
produced in similar channels with suppression from a mixing matrix element
$U_{\alpha 4}$. Due to the energy profile of the BNB, this restricts us to
...
Anelli:2015pba} but will not be considered futher in the paper.
%

The pattern of flavour mixing in the PMNS matrix also influences the production
of $N$. 
%
%Without an underlying theory of flavour, there are no theoretical constraints
%on $U_{\alpha 4}$. 
%
As the meson decay comes with an associated charged lepton, mixing with the
$\tau$-flavour cannot lead to production at the BNB. 
%
This is ultimately the reason for the weaker global constraints on $U_{\alpha
4}$. And for this reason, we will always assume production via a non-zero
$U_{e4}$ or $U_{\mu 4}$. 
...
fermions produced by pion and kaon decays, $1~\text{MeV}\lesssim m_{\ster} \lesssim m_K$. The precise 
