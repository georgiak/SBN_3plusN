...
measurement of the sterile mass.  We can estimate the impact of this
information on the model discrimination given an knowledge of the precision in
timing measurements of the sterile neutrinos. Elementary special relativity
tells us that for an arrival time delay (behind a luminal particle) over a
...
\newtext{MARK}{Working on this last plot for here, generated all the data just need 
to get an answer.} 

\begin{figure}[t] \center
\includegraphics[width=0.6\textwidth]{figures/timing_scatterplots.pdf}
\caption{\label{fig:tof_scatter} The distribution of events at ICARUS for a
...
decaying sterile masses.} \end{figure}
