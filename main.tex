...
of all channels with visible decay products over the mass range producible from
...
model, these decays are sub-dominant with respect to other decays, and are beyond the scope of this work.
