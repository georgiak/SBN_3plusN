...
%
%We focus in particular on two features of the design: the three detectors
%situtated at different baseline distances from the source and the timing
%information that can be associated with each event. 
%
