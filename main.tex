...
enumerated \cite{Atre:2009rg} and searched for in many previous experiments, in particular PS-191 \cite{Bernardi:1985ny}, which ran at CERN in 1983-1985 and produced the strongest decay in flight bounds on $U_{e4}$ and $U_{\mu 4}$ for sterile's in the 1-500 MeV mass range.%
...
One can estimate the sensitivity of the three SBN detectors by a simple exposure calculation. PS-191 was located 128m downstream of the target and $2.3^\circ$ (40 mrads) off axis and obtained $0.86 \times 10^{19}$ POT over the course of its run-time. With a total volume of $6\times3\times12 = 216 \text{m}^3$ we can estimate the ratio of events expected at the three SBN detectors by comparing POT $\times$ Vol $\times$ $R^{-2}$. See Table (\ref{tab:exposure}) for the results of such an exposure comparason.\\
...
In addition to the increased exposure, the energies of resultant heavy steriles produced in the 8 GeV BNB beam is, on average, lower than those produced by the 19.2 GeV proton synchrotron beam used in PS-191. This will further increase the number of expected decays observed as the probability of the sterile to subsequently decay scales as $1/E_\nu$. Thus we expect that the SBN facilities would expect to see more events than PS-191 if all other things remained identical. However, as mentioned above PS-191 was purpositly buily to search for deacys in flight and as such was of low total mass ($\approx 20 $ ton) in order to minimize neutrino scatterig induced background. The SBN detectors were designed for the polar opposite, to study neutrino cross-section related processes, which is reflected in their masses (112, 66.6 and 476 tons respectively). As such to definitively show that SBN has sensitivity to such decays in flight, we must show that the background rejection capability of LAr is sufficiently well understood.
...
\item \sout{Do we understand why we undershoot PS191?}

\item \sout{Finish $e^+e^-$ and $\pi^0$ background analysis. And single photon}

\item \sout{Finalize BG analyses. Add cut information to inflight, generate
	efficiency files. }
