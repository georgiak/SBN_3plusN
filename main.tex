...
sufficiently short-lived sterile, however, could decay back to visible particles
...
decays observed and is not a function of sterile decay-rate. As such peak
...
are driven by both flux intensity and the decay rate of the heavy sterile which
...
sterile mass increases. As discussed in the introduction, PS-191, which ran in
...
suppressed, pushes the total sterile lifetime below $0.1$ s and avoids these
...
approximately $95$\% of the reconstructed sterile angles from these
...
energy steriles are travelling at sufficiently slower speeds than their light
...
\begin{figure}[t]
	...
	250 and 350 MeV respectively. Now this energy is associated with the reconstructed sterile energy. One observes the exact same preference for low energy events and same qualitative behaviour as $m_\ster$ increases. This behaviour is common across all channels studied. Insert shows the stark differences in spectrum when on considers between events falling within the beam bucket window and without. }
	%
\end{figure}
