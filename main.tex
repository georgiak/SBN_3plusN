...
As a consistency check of the above methodology we reproduce the published bounds of the CERN based PS-191 experiment, which ran in 1983-1985 and produced the strongest bounds on $U_{e4}$ and $U_{\mu 4}$ for this sterile mass range. The detector was $6\text{m} \times 3\text{m} \times 12 \text{m}$ and was located 128m downstream of the target. Fluxes of all neutrinos produced from pion sources at PS-191 were obtined from \cite{ps191THesis}. No accurate kaon sources could be obtained and as such only low mass bounds are reproduced here. It must be noted that PS-191 ignored all neutral current contribtions to $\nu_N \rightarrow \nu_\alpha e^+ e^-$ and assumed the steriles were Dirac particles, and as such the bounds are not directly relatable to the minimal model discussed above.
