d1:	sbnfit.cxx model.c correlation.c detector.c prob.h
	...
	g++ -g -std=c++11 -c sbnfit.cxx -o sbnfit2.o  -I $$ROOTSYS/include -Wno-deprecated-declarations
	g++ -g -std=c++11 -c model.c -o model.o -I $$ROOTSYS/include
	g++ -g -std=c++11 -c correlation.c -o correlation.o  -I $$ROOTSYS/include
	g++ -g -std=c++11 -Wall -fPIC  -Wno-deprecated-declarations -I $$ROOTSYS/include -o sbnfit2 sbnfit2.o prob.o model.o detector.o correlation.o `root-config --libs`  -lgsl -lgslcblas 
